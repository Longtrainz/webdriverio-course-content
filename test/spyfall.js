describe('Spyfall Game', function () {
    ...
    it('should allow others to join a game', function () {
        Guest.url('./');
    ...
    it('should allow host to start the game', function () {
